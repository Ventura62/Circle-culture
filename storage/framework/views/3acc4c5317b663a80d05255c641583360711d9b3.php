...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center mr-1">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    <!--begin::Page Title-->
                    <h2 style="color: #3a384e"  class="d-flex align-items-center font-weight-bolder my-1 mr-3">Events <?php echo e(Carbon\Carbon::now()); ?></h2>
                    <!--end::Page Title-->
                </div>
                <!--end::Page Heading-->
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr class="text-left">
                                ...
                                <th style="min-width: 150px">Ends at</th>
                            ...
                            <tr>
                                <?php
                                    $targetTime = Carbon\Carbon::parse($row->time)->addMinutes(180);
                                ...
                                <td >
                                    <a href="<?php echo e(route('event.show' , $row['id'])); ?>" class="text-primary  font-weight-bold"><?php echo e($row->name); ?>  </a>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e(Carbon\Carbon::parse($row->time)->format('F jS, Y h:i A')); ?></span>
                                </td>
                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($targetTime); ?></span>
                                </td>

                                 <td>

                                     <?php if($currentTime->gt($targetTime)): ?>
                                         <span class="label label-lg label-warning label-inline mb-1">  <?php echo e('ended'); ?> </span>
                                     <?php else: ?>
                                         <span class="label label-lg <?php if($row->is_active): ?> label-primary <?php else: ?> label-danger <?php endif; ?> label-inline mb-1" > <?php if($row->is_active): ?> <?php echo e('active'); ?> <?php else: ?> <?php echo e('inactive'); ?> <?php endif; ?> </span>
                                     <?php endif; ?>
                                </td>

                                <td>
                                    <?php if(!$row->is_active): ?>
                                        <a href="#" data-toggle="modal" data-target="#activate_record_modal" data-action="<?php echo e(route('event.activate' , $row->id)); ?>" data-id="<?php echo e($row->id); ?>" class="open_activate_modal btn  btn-warning btn-hover-primary btn-sm">
                                           Activate
                                        </a >
                                    <?php endif; ?>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="<?php echo e(route('event.delete' , $row->id)); ?>" data-id="<?php echo e($row->id); ?>" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="<?php echo e(route('event.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="col-lg-8">
                                    <select name="time" required class="form-control">
                                        ...
                                        <?php $__currentLoopData = $upcoming_dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option  value="<?php echo e($date['date']); ?>"><?php echo e(Carbon\Carbon::parse($date['date'])->format('F jS, Y h:i A')); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="time" required class="form-control">
                                            ...
                                            <?php $__currentLoopData = $upcoming_dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($date['date'] ==  $row['time']): ?> selected <?php endif; ?> value="<?php echo e($date['date']); ?>"><?php echo e(Carbon\Carbon::parse($date['date'])->format('F jS, Y h:i A')); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="is_active" required class="form-control">
                                            ...
                                            <option <?php if($row['is_active']): ?> selected <?php endif; ?> value="1">Active</option>
                                            <option <?php if(!$row['is_active']): ?> selected <?php endif; ?> value="0">Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="activate_record_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Are you sure you want to activate this event ?</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <i aria-hidden="true" class="ki ki-close"></i>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Please confirm that you want to activate this event.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <a href="" id="activate_record_btn" type="submit" class="btn btn-success">Activate</a>
                </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $("body").on("click" , '.open_activate_modal' , function(e){

            var action = $(this).data('action');

            $('#activate_record_btn').attr('href', action);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\hingeApp\resources\views/dashboard/events.blade.php ENDPATH**/ ?>