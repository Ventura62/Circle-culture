                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a  href="<?php echo e(route('group.export')); ?>" class="navi-link">
                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable exportTable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <a href="<?php echo e(route('event.show' , $row['id'])); ?>" class="text-primary  font-weight-bold"><?php echo e($row->event->name); ?>  </a>
                                </td>

                                <td >
                                    <?php $users = json_decode($row['users'] ,true);   ?>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="label label-lg label-primary label-inline mb-1"> <?php echo e($user); ?> </span>

                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['activities']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['topics']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['meet_in']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row->restaurant->location ?? ''); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row['table_number']); ?>  </span>
                                </td>

                                <td >
                                    <span class="text-muted  font-weight-bold"><?php echo e($row->restaurant->name ?? ''); ?>  </span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="<?php echo e(route('group.delete' , $row->id)); ?>" data-id="<?php echo e($row->id); ?>" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="<?php echo e(route('group.import')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\hingeApp\resources\views/dashboard/groups.blade.php ENDPATH**/ ?>