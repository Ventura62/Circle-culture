...
We will notify you via email once 72 Duo officially launches.</span>
            ...
            <form id="nameForm"  action="<?php echo e(route('submission.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH D:\Laravel pros\hingeSubmission\resources\views/welcome.blade.php ENDPATH**/ ?>