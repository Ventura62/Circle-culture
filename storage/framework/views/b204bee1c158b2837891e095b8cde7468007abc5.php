        ...
        <path d="M16,3 L19,3 C20.1045695,3 21,3.8954305 21,5 L21,15.2485298 C21,15.7329761 20.8241635,16.200956 20.5051534,16.565539 L17.8762883,19.5699562 C17.6944473,19.7777745 17.378566,19.7988332 17.1707477,19.6169922 C17.1540423,19.602375 17.1383289,19.5866616 17.1237117,19.5699562 L14.4948466,16.565539 C14.1758365,16.200956 14,15.7329761 14,15.2485298 L14,5 C14,3.8954305 14.8954305,3 16,3 Z" fill="#000000"></path>
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    ...
                                    <li class="navi-item">
                                        <a  href="<?php echo e(route('submissions.export')); ?>" class="navi-link">
                        ...
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable exportTable" id="kt_advance_table_widget_1">
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><span class="text-muted text-capitalize font-weight-bold"> <?php echo e($row->user->name ?? ''); ?> </span></td>

                                    <td><span class="text-muted font-weight-bold"> <?php echo e($row->user->email ?? ''); ?> </span></td>

                                    <td><span class="text-muted font-weight-bold"> <?php echo e(isset($row->booking_date) ? \Carbon\Carbon::parse($row->booking_date)->format('F jS, Y h:i A') : ''); ?> </span></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\hingeApp\resources\views/dashboard/submissions.blade.php ENDPATH**/ ?>