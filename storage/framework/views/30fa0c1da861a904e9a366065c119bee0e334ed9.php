    ...
    <div class="container pt-130 pb-130 mt-n10 ">
        <div class="row gh-1 gv-1 align-items-center align-items-lg-stretch flex-column flex-lg-row">
            ...
            <div class="col-12 col-lg ms-lg-n30 order-4 order-lg-3 show-on-scroll" data-show-duration="600" data-show-distance="10">
                ...
                <form  id="profile-form" class="form" method="POST" action="<?php echo e(route('profile.store')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="profile-header">
                        <div class="profile-image-container">
                            <img src="<?php if(isset(auth()->user()->profile_pic)): ?> <?php echo e(asset(auth()->user()->profile_pic)); ?> <?php else: ?> <?php echo e(asset('avatar.png')); ?> <?php endif; ?>" alt="Profile" class="profile-image" id="profile-image">
                        </div>
                    ...
                    <div class="section-card">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                <input type="text" class="info-input" name="name" value="<?php echo e(auth()->user()->name); ?>" required>
                            </div>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Email</span>
                            <div class="info-value">
                                <input type="email" class="info-input" name="email" value="<?php echo e(auth()->user()->email); ?>" disabled>
                            </div>
                        </div>
                        <div class="info-item">
                    ...
                    <div class="section-card">
                        ...
                        <div class="info-item">
                            ...
                            <label class="toggle-switch">
                                <input type="checkbox" name="enable_notifications" <?php if(auth()->user()->enable_notifications): ?> checked <?php endif; ?>>
                    ...
                    <?php if(auth()->user()->subscribed()): ?>
                        <div class="section-card">
                            ...
                            <div class="info-item">
                                <a href="<?php echo e(route('subscription')); ?>" class="info-label">Manage My Subscription</a>
                    ...
                    <a style="text-decoration: none; justify-content: center; display: flex" onclick="openResetModal()" data-action="<?php echo e(route('submission.reset')); ?>" type="button" class="action-button delete-btn restBtn">Reset my submission</a>

                    <a style="text-decoration: none; justify-content: center; display: flex; background: red; color: white" onclick="openModal()" data-action="<?php echo e(route('account.delete')); ?>" type="button" class=" action-button delete-btn delBtn">Delete my account</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\hingeApp\resources\views/web/profile.blade.php ENDPATH**/ ?>