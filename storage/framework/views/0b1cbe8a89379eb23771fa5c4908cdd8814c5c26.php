    ...
    <div class="py-100 bg-dark">
        <div class="container">
            <div class="form-container">
                ...
                <input class="old_answers" hidden value="<?php echo e($old_answers); ?>">
                <input class="old_step" hidden value="<?php echo e($next_step ?? 1); ?>">

                <div class="step-container <?php if(!$next_step): ?> active <?php endif; ?>" data-step="1">
                    ...
                    <?php else: ?>
                    <div style="width:100%; display: flex">
                        <a href="<?php echo e(route('login')); ?>" style="margin-top: 15px; text-align: center; text-decoration: none;" class="stepBtn " data-next="2">
                ...
                <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($question['type'] == 'label'): ?>
                        <?php
                            $currentLabel = $question['name'];
                        ?>
                    <?php else: ?>
                        <?php ++$stepNumber; ?> 
                        <div class="step-container <?php if($next_step && $next_step ==  $stepNumber): ?> active <?php endif; ?>" data-id="<?php echo e($question['id']); ?>" data-step="<?php echo e($stepNumber); ?>">
                            <?php if($currentLabel): ?> 
                            <div class="label-container">
                                <h2><?php echo e($currentLabel); ?></h2>
                            </div>
                            <?php endif; ?>

                            <h2><?php echo e($question['name']); ?></h2>

                            <?php if($question['type'] == "multi-choice"): ?>
                                <?php $answers = json_decode($question['answers_arr'] ,true); ?>
                                ...
                                <?php if(count($answers) == 1): ?>
                                    ...
                                    <div style="width:100%; display: flex">
                                        <button class="stepBtn next-button option" data-next="<?php echo e($stepNumber+1); ?>">
                                            <span><?php echo e($answers[0]); ?></span>
                                        </button>
                                    </div>

                                <?php elseif(count($answers) == 3): ?>
                                        <div class="options mutli-choice-option" style="grid-template-columns: repeat(3, minmax(100px, 1fr))">
                                            <?php $__currentLoopData = $answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="option answer" data-next="<?php echo e($stepNumber+1); ?>">
                                ...
                                <?php endif; ?>
                            <?php elseif($question['type'] == "multi-choice-checkbox"): ?>
                                    <?php $answers = json_decode($question['answers_arr'] ,true); ?>

                                    <div class="checkbox-container">
                                        <?php $__currentLoopData = $answers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="checkbox-option">
                                                <input type="checkbox" class="checkbox-input" value="<?php echo e($answer); ?>">
                                                <div class="checkbox-custom"></div>
                                                <span class="checkbox-label"><?php echo e($answer); ?></span>
                                            </label>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>

                                    <div class="checkbox-button-container" style="width:100%; display: flex">
                                        <button class="stepBtn checkbox-button option" disabled  data-next="<?php echo e($stepNumber+1); ?>">
                                            <span>Next</span>
                                        </button>
                                    </div>
                            ...
                            <?php elseif($question['type'] == "phone"): ?>
                                <div class="phone-container">
                                    ...
                                    <div class="phone-button-container" style="width:100%; display: flex">
                                        <button class="stepBtn next-button option" disabled  data-next="<?php echo e($stepNumber+1); ?>">
                                            <span>Next</span>
                                        </button>
                                    </div>
                                </div>
                            ...
                            <?php elseif($question['type'] == "date"): ?>
                                    ...
                                    <div class="date-button-container" style="width:100%; display: flex">
                                        <button class="stepBtn next-button option"  disabled data-date="1" data-next="<?php echo e($stepNumber+1); ?>">
                                            <span>Next</span>
                                        </button>
                                    </div>
                            <?php elseif($question['type'] == "scale"): ?>
                                <div class="options">
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <div class="option answer" data-next="<?php echo e($stepNumber+1); ?>"><span><?php echo e($i); ?></span></div>
                                    <?php endfor; ?>
                                </div>

                                <br>
                                <span style="color: white" class="mt"> <?php echo e($question['scale_1']); ?></span>
                                <span style="color: white;float: inline-end;"> <?php echo e($question['scale_2']); ?></span>
                            <?php endif; ?>

                        </div>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <div class="step-container  <?php if($next_step == $stepNumber+1): ?> active <?php endif; ?>" data-step="<?php echo e($stepNumber+1); ?>">
                    <h2>Thank you!</h2>
                    ...
                    <div style="width:100%; display: flex">
                        <a style="text-decoration: none; text-align: center" href="<?php echo e(route('register')); ?>" class="stepBtn saveAnswers" >
                            <span>Next</span>
                        </a>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.web.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\hingeApp\resources\views/web/start.blade.php ENDPATH**/ ?>