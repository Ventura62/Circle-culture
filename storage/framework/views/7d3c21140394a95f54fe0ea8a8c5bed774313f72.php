                        ...
                        <form class="form" method="POST" action="<?php echo e(route('settings.store')); ?>" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="message" class="form-control"><?php echo e($settings['message']); ?></textarea>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel pros\picAi\resources\views/dashboard/settings.blade.php ENDPATH**/ ?>