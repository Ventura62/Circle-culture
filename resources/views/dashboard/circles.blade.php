                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <img  width="50%" src="{{ asset($row->image) }}"/>
                                </td>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold">{{ $row['long_description']  }}  </span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="{{ route('circle.delete' , $row->id) }}" data-id="{{ $row->id }}" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ route('circle.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <form class="form" method="POST" action="{{ route('circle.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label">Short Description:</label>
                                    <div class="col-lg-8">
                                        <textarea rows="5"  class="form-control" name="short_description" >{{$row['short_description']}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label">Long Description:</label>
                                    <div class="col-lg-8">
                                        <textarea rows="5"  class="form-control" name="long_description" >{{$row['long_description']}}</textarea>
                                    </div>
                                </div>
