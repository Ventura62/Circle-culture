                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable exportTable" id="kt_advance_table_widget_1">
                            ...
                            @foreach($data as $key => $row)
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold">{{ $row['type']  }}  </span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="{{ route('question.delete' , $row->id) }}" data-id="{{ $row->id }}" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">
                                        <span class="svg-icon svg-icon-md svg-icon-primary">
                        ...
                        <form class="form" method="POST" action="{{ route('question.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label ">Type:</label>
                                    <div class="col-lg-8">
                                        <select class="form-control question_type" data-id="{{ $row['id'] }}" name="type">
                                            <option @if($row['type'] == 'scale') selected @endif >scale</option>
                                            <option @if($row['type'] == 'multi-choice') selected @endif >multi-choice</option>
                                            <option @if($row['type'] == 'multi-choice-checkbox') selected @endif >multi-choice-checkbox</option>
                                            <option @if($row['type'] == 'short-text') selected @endif>short-text</option>
                                            <option @if($row['type'] == 'long-text') selected @endif>long-text</option>
                                            <option @if($row['type'] == 'date') selected @endif>date</option>
                                            <option @if($row['type'] == 'phone') selected @endif>phone</option>
                                            <option @if($row['type'] == 'label') selected @endif>label</option>
                                        </select>
                                    </div>
                                </div>
                               ...
                               <div class="separator separator-dashed my-8"></div>
                                ...
                                <div class="form-group row scale_option-{{ $row['id'] }}"  @if($row['type'] != 'scale') style="display: none" @endif>
                                    <label class="col-lg-4 col-form-label ">Scale 1:</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="scale_1" value="{{ $row['scale_1'] }}" placeholder=""   />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row scale_option-{{ $row['id'] }}"  @if($row['type'] != 'scale') style="display: none" @endif>
                                    <label class="col-lg-4 col-form-label ">Scale 2:</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="scale_2" value="{{ $row['scale_2'] }}" placeholder=""   />
                                    </div>
                                </div>

                                <div class="form-group row question-{{ $row['id'] }} " @if($row['type'] == 'multi-choice' || $row['type'] == 'multi-choice-checkbox') @else style="display: none;" @endif>
                                    <label class="col-lg-4 col-form-label ">Answer:</label>
                                    <div class="col-lg-8">
                                        <div id="kt_repeater_1" class="col-lg-10" >
                                            <div class="row targetDiv " id="">
                                                ...
                                                <div  class="fvrduplicate-qch">
                                                    @php $answers = json_decode($row->answers_arr , true);  @endphp
                                                    @if(count($answers) > 0)
                                                        @foreach($answers as $key => $answer)
                                                            <div class="row entry-qch">
                                                                <input class="form-control" name="answers_arr[]" value="{{ $answer }}">
                                                                <div class="">
                                                                    <div class="form-group">
