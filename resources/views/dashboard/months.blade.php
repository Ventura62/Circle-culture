                            ...
                            <tr>
                                ...
                                <td >
                                    @foreach($row->cities as $city)
                                        <span class="label label-lg label-primary label-inline mb-1"> {{ isset($city->name) ? $city->name . ', '  . $city->country: null }} </span>
                                    @endforeach
                                </td>
                                ...
                                <td>
                                    ...
                                    {{--<a href="#" data-toggle="modal" data-target="#delete_record_modal" data-action="{{ route('month.delete' , $row->id) }}" data-id="{{ $row->id }}" class="open_delete_modal btn btn-icon btn-light btn-hover-primary btn-sm">--}}
                                        {{--<span class="svg-icon svg-icon-md svg-icon-primary">--}}
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!--begin::Form-->
                    <form class="form" method="POST" action="{{ route('month.store') }}" enctype="multipart/form-data">
                        @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <form class="form" method="POST" action="{{ route('month.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" name="name">
                                        <option @if($row['name'] == 'January') selected @endif>January</option>
                                        <option @if($row['name'] == 'February') selected @endif>February</option>
                                        <option @if($row['name'] == 'March') selected @endif>March</option>
                                        <option @if($row['name'] == 'April') selected @endif>April</option>
                                        <option @if($row['name'] == 'May') selected @endif>May</option>
                                        <option @if($row['name'] == 'June') selected @endif>June</option>
                                        <option @if($row['name'] == 'July') selected @endif>July</option>
                                        <option @if($row['name'] == 'August') selected @endif>August</option>
                                        <option @if($row['name'] == 'September') selected @endif>September</option>
                                        <option @if($row['name'] == 'October') selected @endif>October</option>
                                        <option @if($row['name'] == 'November') selected @endif>November</option>
                                        <option @if($row['name'] == 'December') selected @endif>December</option>
                                    </select>
                                </div>
                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div id="group1" class="fvrduplicate-qch">
                                                    ...
                                                    @if(count($row->cities) > 0)
                                                        @foreach($row->cities as $key => $month_city)
                                                            <div class="row entry-qch">
                                                                <select class="form-control" name="cities[]">
                                                                    <option selected disabled >Please Select</option>
                                                                    @foreach($cities as $city)
                                                                        <option @if($month_city['id'] == $city['id']) selected  @endif value="{{ $city['id'] }}">{{ $city['name']  . ', ' . $city['country'] }}</option>
                                                                    @endforeach
                                                                </select>
                                                                <div class="">
                                                                    <div class="form-group">
                                                                        @if($key == count($row->cities ) - 1)
                                                                            <button type="button" class="mt-2 form-control btn btn-sm font-weight-bolder btn-light-primary btn-add-qch">
                                                                                <i class="la la-plus"></i>Add
                                                                            </button>
                                                                        @else
