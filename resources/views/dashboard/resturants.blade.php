                    ...
                    <div class="table-responsive">
                        <table class="table table-head-custom table-vertical-center order-table kt_datatable" id="kt_advance_table_widget_1">
                            ...
                            <tr>
                                ...
                                <td >
                                    <span class="text-muted  font-weight-bold">{{ $row['location']   }}  </span>
                                </td>
                        ...
                        <form class="form" method="POST" action="{{ route('restaurant.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row d-none">
                                    <label class="col-lg-4 col-form-label">Description:</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="description" placeholder="Enter Description Here" value="{{ $row['description'] }}"   />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label">Location:</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" name="location" placeholder="Enter Location Here" value="{{ $row['location'] }}"  required />
                                    </div>
                                </div>
