    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .form-section {
                ...
                min-height: 100vh;
                padding: 1.5rem;
                background-image: url({{ asset('fading.gif') }});
...
@section('content')
    ...
    <main class="hero">
        ...
        <div class="hero-content">
            ...
            <a href="{{ route('start') }}" class="cta-button">Sign up</a>
        </div>
    ...
    <div class="form-container">
        ...
        <div class="image-section" style=" background-image: url({{ asset('fading.jpeg') }})"></div>
    </div>
    ...
    <div id="faqSection" class="py-130  overflow-hidden  shape-parent p-20">
        ...
        <div class="faq-container">
            ...
            <div class="faq-item">
                ...
                <div class="faq-answer">
                    <p>The $16 signup fee covers the logistics of matching and making reservations. Simply show up and enjoy! Please note that dinner costs are paid directly by the attendees.</p>
                </div>
            </div>
    ...
    <footer class="footer text-white shape-parent overflow-hidden text-center pt-10 pb-60" style="background-color: #000">
        <div class="container pt-40">
            <ul class="nav nav-social nav-gap-sm align-items-center justify-content-center mb-30 text-white">
                ...
                <li class="nav-item">
                    <a style="padding: 7px 26px;font-size: 15px" class="theme-button d-sm-inline-block" href="{{ route('start') }}"> Sign up </a>
