                            ...
                            @if($member['email'] != auth()->user()->email)
                                <div class="attendee-card">
                                    ...
                                    <div class="voting-options">
                                        <button data-email="{{ $member['email'] }}" class="vote-btn yes" data-name="{{ $member['name'] }}" data-vote="yes">
                                            Yes 👍
                                        </button>
                                        <button data-email="{{ $member['email'] }}"  class="vote-btn no" data-name="{{ $member['name'] }}"  data-vote="no">
                                            No 👎
                                        </button>
                                        <button data-email="{{ $member['email'] }}"  class="vote-btn not-there" data-name="{{ $member['name'] }}" data-vote="not-there">
                                            Not there 🤔
                                        </button>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function saveAnswers(jsonString) {
                $.ajax({
                    url: '{{ route('feedback.store') }}', // Backend route to store answers temporarily
                    type: 'POST',
                    data: {
                        event_id: '{!! $eventId !!}',
