...
const Step1 = () => {
  ...
  return (
    <>
      <h2 className="text-xl md:text-3xl ">Let’s create your first Circle!</h2>
      <div className=" flex md:ml-[-200px] mt-10 md:mt-20 flex-col  gap-4 font-medium text-white p-6 border-l-2 border-white max-w-2xl mx-auto">
        ...
        <p className="mb-6 text-gray-300">
          A Circle is a small gathering (4-6 people) where guests pay to join
          and connect. New hosts start with one Circle and can grow to hundreds
          if successful.
        </p>
        ...
        <ul className="mb-6 list-disc list-inside text-gray-300">
          <li>
            Host meaningful gatherings and earn for your effort, even if you
            can't join!
          </li>
          <li>Review profiles, set the vibe, and join if you’d like!</li>
          <li>Be part of a movement of tackling Social Isolation</li>
        </ul>

        <h2 className="text-xl font-bold mb-2">Getting Started is Easy!</h2>
        <ul className="list-disc list-inside text-gray-300">
          <li>It only takes a few mins to create a Circle</li>
          <li>
            Your first Circle is a learning experience, and you can stay
            anonymous if you prefer
          </li>
          <li>
            If your first Circle doesn’t take off, you can always try again and
            your rating won’t be affected!
          </li>
        </ul>
      </div>
