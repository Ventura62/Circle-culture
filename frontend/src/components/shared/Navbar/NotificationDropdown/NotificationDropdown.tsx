        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button
                    variant="none"
                    size="icon"
                    className="relative rounded-full !bg-primary text-white hover:!bg-white/15"
                >
            ...
            <DropdownMenuContent align="end" className="w-80 p-4 !bg-primary">
                <DropdownMenuLabel className="mb-2 text-xl font-medium">
                    Notifications
                </DropdownMenuLabel>
