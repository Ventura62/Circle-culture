...
import { RiLinkedinBoxLine, RiInstagramLine, RiPhoneLine } from "react-icons/ri";
            ...
            <div className="bg-primary rounded-lg border-1.5 border-white/35 py-12 px-24 max-656:px-10 flex flex-col gap-4">
                <div className="flex items-center gap-6 max-656:flex-col max-656:gap-0">
                    <div className="w-44 h-44 bg-transparent relative border-8 border-white rounded-full flex-shrink-0 mb-4 flex items-center justify-center">
                        <Image height={64} width={64} className="absolute -left-6 bg-white rounded-full p-1.5 h-10 w-10" src={Salute.src} alt="Monkey Emoji" />
                        <Image height={64} width={64} className="absolute left-2 -top-2 bg-white rounded-full p-1.5 h-10 w-10" src={Heart.src} alt="Handshake Emoji" />
                        <Image height={64} width={64} className="absolute right-0 top-0 bg-white rounded-full p-1.5 h-10 w-10" src={Hundred.src} alt="Hundred Emoji" />
                ...
                <div className="flex items-stretch justify-center flex-wrap gap-4">
                    <div className="w-[46%] min-w-48 flex items-center justify-center gap-4 bg-background border-1.5 border-white/35 rounded-md p-3">
                        <Image height={64} width={64} className="h-16 w-16" src={Heart.src} alt="Handshake Emoji" />
                        <div>
                            <h1>Friends</h1>
                            <p className="font-bold text-xl text-center">{userData.friends}</p>
                        </div>
                    </div>
                    <div className="w-[46%] min-w-48 flex items-center justify-center gap-4 bg-background border-1.5 border-white/35 rounded-md p-3">
                        <Image height={64} width={64} className="h-16 w-16" src={Heart.src} alt="Handshake Emoji" />
                        <div>
                            <h1>Trios Joined</h1>
                            <p className="font-bold text-xl text-center">{userData.triosJoined}</p>
                        </div>
                    </div>
                </div>
            </div>
