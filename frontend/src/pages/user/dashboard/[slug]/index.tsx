        ...
        <div className="text-white mx-auto max-w-[68rem] pb-10 max-1100:mx-10 max-592:mx-4">
            <div className="flex items-center justify-between mb-10 max-878:flex-col max-878:gap-4 max-878:items-start">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-3xl max-470:text-2xl">
                        Edit Your Circle
                    </h1>
                </div>

                {/* Edit Option Side Buttons */}
                <div className="flex max-592:flex-wrap items-center gap-6 max-878:flex-1 max-878:mx-auto">
                    <Link
                        href={`/user/dashboard/${slug}/times`}
                        className="text-center max-592:text-sm text-lg whitespace-nowrap w-[150px] max-592:w-[130px] text-[11px] py-2 px-4 border-1.5 border-white rounded-md hover:bg-white hover:text-primary transition-all duration-200"
                    >
                        Edit Event Times
                    </Link>
                    <Link
                        ...
                        <AlertDialogContent className="!bg-primary !text-white">
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription className="text-center text-base">
                                    This will permanently remove all reviews and
                                    history linked to this Circle.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
            ...
            <div>
                <form
                    className="flex flex-col gap-4 max-w-[40rem]"
                ...
                >
                    ...
                    <div className="w-full text-left flex flex-col gap-2">
                        ...
                        <Dropdown
                            ...
                            setValue={(value) =>
                                setCategory(
                                    value as keyof typeof CircleCategoryEnum.Enum
                                )
                            }
                        />
                    </div>
                    <div className="w-full text-left flex flex-col gap-2">
                        ...
                        <Dropdown
                            ...
                            setValue={(value) =>
                                setCriteria(
                                    value as keyof typeof CircleCriteriaEnum.Enum
                                )
                            }
                        />
